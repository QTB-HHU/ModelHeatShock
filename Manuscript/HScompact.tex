...
\begin{figure*}
\centering
\includegraphics[width=\textwidth]{Figure9_SupMat.pdf}
\caption{\small{\textbf{Robustness of our results against changes in the parameters related to the Hill kinetics employed to describe the activation of the stress kinases.} \textbf{(A-...)} ... FIX ME ...}}
\label{Figure9label}
\end{figure*}
...
\caption{\small{\textbf{Effect on the RMS of small changes in each parameter.} \textbf{(A-...)} ... FIX ME ...}}
\label{Figure10label}
\end{figure*}
